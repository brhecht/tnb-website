...
shortDef: >-
  Using AI tools to build and test working prototypes extremely quickly, cycling
  through versions based on real feedback rather than spending long periods
  planning upfront. The model does the scaffold; you steer.
---
